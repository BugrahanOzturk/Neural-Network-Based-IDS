...
if __name__ == "__main__":
	...
	valid_dataloader = torch.utils.data.DataLoader(valid_data, batch_size = config.BATCH_SIZE_TEST, shuffle = False, num_workers=config.NUM_WORKERS)
	...
	# train model
	train(feed_forward_net, train_dataloader, valid_dataloader, loss_fn, optimizer, config.EPOCHS, config.VAL_PER_EPOCH, validation=True, tensorboard_report=True)
